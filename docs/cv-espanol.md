# Guillermo Leon Rodriguez

**Data Analyst / Business Intelligence Analyst**

📧 guillermojleonr@gmail.com | 📱 +56 9 5495 5690  
🔗 [GitHub](https://github.com) | 📝 [Blog / Portfolio](https://savingl.cl/)
...
- **Transformación de datos:** Pandas, PowerQuery
...
- **ETL:** Centralizando desde múltiples orígenes: POS, Ecommerce, Marketplaces, hojas de cálculo hacia base de datos SQL.
  - Diseño por capas, modular y orientado a objetos.
  - Jobs gatillados por eventos, programados o manuales. 
  - Colas de tareas y asincronía en extracciones grandes y sincronía en el resto.
  - Técnicas de extracción: fetching a APIs REST-GraphQL o scraping.
  - Transformaciones con pandas o SQL.
  - Técnicas de carga: UPSERT, incremental, truncate-reload.
- **Procesamiento de imágenes:** Modelos de IA para generar data masivamente: Atributos de productos forma, estructura, color y nuevas imágenes a partir de imágenes de referencia, ahorrando cientos de horas de trabajo que se realizaba manualmente por operadores.
- **Notificaciones:** Sistema de alertas por email avisando sobre eventos relevantes relacionados con el control de stock, ventas, notas de crédito, despachos, errores o problemas operativos.
...
### Data Analyst - Mr. Rocket Express
*Enero 2021 - Octubre 2022*

El problema más grande era la entrada de datos de cientos de paquetes diarios hacia un sistema logístico, para mejorar el proceso desarrollé macros en principio y posteriormente una web app Python-Django para extraer data de la API de MercadoLibre y cargarla al sistema, un ETL basado en VBS/VBA para la ingesta de datos desde archivos locales, un cliente SQL con formulario para las consultas más sencillas y recurrentes, y reportería en Power BI.

### Implementador Wordpress - Savingl.cl
*Marzo 2021*
Creación y administración web de servicios. Gestión de hosting, dominio y seguridad.

### Roles Previos (Administración y Logística)
Roles de analista empleando fundamentalmente Excel y SQL.
- **Analista de Operaciones** - Ferretería Barrena *(Dic 2017 - Sep 2018)*
