...
- **Data Transformation:** Pandas, PowerQuery
- **Visualization and Modeling:** Power BI, DAX
...
- **ETL:** Centralizing from multiple sources: POS, Ecommerce, Marketplaces, spreadsheets into an SQL database.
  - Layered, modular, and object-oriented design.
  - Jobs triggered by events, scheduled, or manual. 
  - Task queues and asynchrony for large extractions, and synchrony for the rest.
  - Extraction techniques: fetching from REST/GraphQL APIs or scraping.
  - Transformations with Pandas or SQL.
  - Loading techniques: UPSERT, incremental, truncate-reload.
- **Image Processing:** AI models to generate data at scale: product attributes (shape, structure, color) and new images from reference images, saving hundreds of hours of manual work performed by operators.
- **Notifications:** Email alert system notifying about relevant events related to stock control, sales, credit notes, dispatches, errors, or operational issues.
...
The biggest problem was data entry of hundreds of packages daily into a logistics system. To improve this process, I initially developed macros, and later a Python-Django web app to extract data from the MercadoLibre API and load it into the system. I also developed a VBS/VBA-based ETL for data ingestion from local files, an SQL client with a form for simple and recurring queries, and reporting in Power BI.

### Wordpress Implementer - Savingl.cl
*March 2021*
Creation and web administration of services. Hosting, domain, and security management.

### Previous Roles (Administration and Logistics)
Analyst roles primarily using Excel and SQL.
- **Operations Analyst** - Barrena Hardware Store *(Dec 2017 - Sep 2018)*
